...
export const prisma = (() => {
    if (globalForPrisma.prisma) {
        ...
        if (process.env.NODE_ENV !== "production" && !globalForPrisma.__prisma_schema_v3) {
            delete globalForPrisma.prisma;
            globalForPrisma.__prisma_schema_v3 = true;
        } else {
            return globalForPrisma.prisma;
        }
    }
    if (process.env.NODE_ENV !== "production") globalForPrisma.__prisma_schema_v3 = true;
    return makePrisma();
})();
